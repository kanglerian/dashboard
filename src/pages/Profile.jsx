  ...
  return (
    <main className="flex flex-col justify-center items-center bg-black h-screen">
      <header className='flex flex-col justify-center items-center gap-5'>
        <img src={ManImage} alt="Lerian Febriana, A.Md.Kom" className='w-32 h-32' />
        <div className='flex flex-col justify-center gap-2 text-center'>
          <h1 className='text-white font-bold text-xl'>Lerian Febriana, A.Md.Kom</h1>
          <p className='text-gray-200 text-sm'>Orangnya suka ngulik, penasaran, suka penghijauan. Pengen jadi ahli IT 👋🏼</p>
          <p className='text-gray-200 text-sm'>@kanglerian . Indonesian 🇮🇩 . Coding . Anak IT</p>
          <Link to={`/`} className='text-white hover:text-sky-400 text-sm underline space-x-2'>
